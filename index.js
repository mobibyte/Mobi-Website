...
var CLIENT_ID =
  "840378642603-9ssjr5mnoc1h0itojl37717fin56bb32.apps.googleusercontent.com";
...
function register(data) {
  ...
  const id = "0a24065ed9";
  const url =
    "https://idappthat.us7.list-manage.com/subscribe/post-json?u=" +
    u +
    "&id=" +
    id +
    "&c=?";
  ...
  $.ajax({
    ...
    error: function(err) {
      alert("Could not register at this time...");
    },
